...
const SCRIPT_COMMAND create_char 						= { 0x009A, "iifffv" };
...
const SCRIPT_COMMAND release_model 						= { 0x0249,	"i" };		// model
...
const SCRIPT_COMMAND set_current_char_weapon			= { 0x01B8, "ii" };	// actor handle, weapon

const SCRIPT_COMMAND set_current_player_weapon			= { 0x01B9, "ii" };	// actor handle, weapon
...
const SCRIPT_COMMAND get_current_char_weapon			= { 0x0470, "iv" }; // actor handle, weapon
...
const SCRIPT_COMMAND clear_char_tasks 					= { 0x0687, "i" }; // actor handle
...
const SCRIPT_COMMAND is_player_using_jetpack			= { 0x0A0C, "i" }; // player handle
...
const SCRIPT_COMMAND kill_actor 						= { 0x0321, "i" }; // actor handle
...
const SCRIPT_COMMAND get_actor_distance_from_ground 	= { 0x0819, "iv" }; // actor handle, fRet

const SCRIPT_COMMAND is_actor_falling_think				= { 0x0818, "i" }; // actor handle

const SCRIPT_COMMAND is_actor_in_the_water				= { 0x04ad, "i" }; // actor handle
...
const SCRIPT_COMMAND remove_building					= { 0x0363, "ffffii" };
...
const SCRIPT_COMMAND is_char_sitting_in_any_vehicle		= { 0x0449, "i" }; // actor handle
