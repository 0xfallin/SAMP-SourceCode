...
{
	float fDamage = thiz->fDamage / 3.05; // find the perfect damage pls :(
...
void InstallSpecialHooks()
{
	...
	//ARMHook::installHook(g_libGTASA+string2Offset(AY_OBFUSCATE_KEY("0x55E090", 'v')), (uintptr_t)CBulletInfo__AddBullet_hook, (uintptr_t*)&CBulletInfo__AddBullet);
}
...
void InstallHooks()
{
	...
	//ada SetUpHook(g_libGTASA+0x56668C, (uintptr_t)CWeapon_FireSniper_hook, (uintptr_t*)&CWeapon_FireSniper);
	...
	SetUpHook(g_libGTASA+0x327528, (uintptr_t)CPedDamageResponseCalculator__ComputeDamageResponse_hook, (uintptr_t*)&CPedDamageResponseCalculator__ComputeDamageResponse);
	...
	//AUTOSTART
	SetUpHook(g_libGTASA+0x261C8C, (uintptr_t)StartGameScreen_OnNewGameCheck_hook, (uintptr_t*)&StartGameScreen_OnNewGameCheck);
	SetUpHook(g_libGTASA+0x266B10, (uintptr_t)StartGameScreen_OnLoadGame_hook, (uintptr_t*)&StartGameScreen_OnLoadGame);
